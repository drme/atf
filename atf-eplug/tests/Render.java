...
public class Render
{
    ...
    private void MarkSuspect(int i, int j, boolean flag)
        throws TriangleException
    {
        int k;
        if(0 > (k = FindEdge(i, j)))
    ...
    private float Rho(float f, float f1, float f2, float f3, float f4, float f5)
    {
        float f6 = f4 - f2;
        float f7 = f5 - f3;
        float f8 = f - f4;
    ...
    private boolean insideTriangle(float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7)
    {
        float f8 = f4 - f2;
        float f9 = f5 - f3;
        float f10 = f - f4;
    ...
    public java.util.List triangulate(java.util.List points) throws Throwable
    {
    	this.clear();
    	...
    	{
    		this.points_x[i] = ((Point)points.get(i)).x;
    		this.points_y[i] = ((Point)points.get(i)).y;
    	}
    ...
    private float points_x[];
    private float points_y[];
    ...
    private static final Color lightGray = new Color(0xf0f0f0);
