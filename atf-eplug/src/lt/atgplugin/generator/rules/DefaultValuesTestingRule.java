...
public class DefaultValuesTestingRule extends Rule {
	...
	public String getDescription() {
		return "This rule is used for testing methods with calling some default values. ";
	...
	public String getName() {
		return "Default values testing rule";
	}
